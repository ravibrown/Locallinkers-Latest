...
namespace DataAccess
{
    ...
    public partial class tbl_Coupons
    {
        ...
        public tbl_Coupons()
        {
            this.tbl_CouponImages = new HashSet<tbl_CouponImages>();
        }
        ...
        public Nullable<bool> IsAsPerBill { get; set; }
    
        public virtual tbl_Category tbl_Category { get; set; }
        public virtual tbl_Cities tbl_Cities { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<tbl_CouponImages> tbl_CouponImages { get; set; }

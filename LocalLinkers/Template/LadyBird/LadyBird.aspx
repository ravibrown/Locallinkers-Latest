...
<body>
    <form id="form1" runat="server">
        ...
        <div>
                    ...
                    <div class="container">
                        ...
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav navbar-right">
                                <li id="liHome" runat="server" class="current"><a href="#section1">Home</a></li>
                                <li id="liServices" runat="server"><a href="#section2">Services</a></li>
                                <li id="liAbout" runat="server" ><a href="#section3">About Us</a></li>
                                <li id="liPortfolio" runat="server" ><a href="#section6">Portfolio</a></li>
                                <li id="liContact" runat="server" ><a href="#section7">Contact</a></li>
                            </ul>
                        </div>
                        <!--/.nav-collapse -->
                    </div>
            ...
            <!-- Service/how to -->
            <div id="section2" runat="server" clientidmode="Static">
                            ...
                            <asp:Repeater ID="rptServices" runat="server">
                                <ItemTemplate>
                                    <div class="col-md-3" data-uk-scrollspy="{cls:'uk-animation-scale-up', delay:<%#Convert.ToInt32(Eval("SNO"))*300 %>}">
                                        <%#Container.ItemIndex==0?"<i class=\"fa fa-user\" aria-hidden=\"true\"></i>":
                                                 
                                            Container.ItemIndex==1?"<i class=\"fa fa-star\" aria-hidden=\"true\"></i>":
                                             Container.ItemIndex==2?"<i class=\"fa fa-flag\" aria-hidden=\"true\"></i>":
                                            Container.ItemIndex==3?"<i class=\"fa fa-trophy\" aria-hidden=\"true\"></i>":
            ...
            <!-- Feature Section -->
            <div id="section3" runat="server" clientidmode="Static">
                        ...
                        <div class="wrapper container fet">
                            <div class="row spc">
                                ...
                                <div class="col-md-6" data-uk-scrollspy="{cls:'uk-animation-slide-right'}">
                                    <h3><%#!string.IsNullOrEmpty(Convert.ToString( Eval("tagline")))?Eval("tagline"):"About Us" %></h3>
                                    <p><%#Eval("AboutUs") %></p>
                                </div>
                            </div>
                        </div>
            ...
            <!-- Pricing Table -->
            <div id="section6" runat="server" clientidmode="Static">
            ...
            <!-- Footer -->
            <div class="footer deepblue_footer" id="section7" runat="server" clientidmode="Static">
                <div class="container text-center">
            ...
            <script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyCeszX1LpqPGWQLEQ7LcJBWlh15jUo7JFQ"></script>

...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <header>
                <div class="home-nav">
                    <div class="container">
                        ...
                        <div class="logo">
                            <a href="#home" title="Bold | Responsive One Page Template"><span class="fa fa-ticket logo-icon"></span>
                        ...
                        <nav id="home-menu">
                            <ul id="home-menu-nav">
                                <li id="liHome" runat="server"  class="current"><a href="#home">Home</a></li>
                                <li id="liAboutUs" runat="server" ><a href="#about">About Us</a></li>
                                <li id="liServices" runat="server" ><a href="#services">Services</a></li>
                                <li id="liPortFolio" runat="server" ><a href="#work">Portfolio</a></li>
                                <li id="liContact" runat="server" ><a href="#contact">Contact</a></li>
                            </ul>
                        </nav>
            ...
            <div id="home" runat="server" clientidmode="Static">
                <section class="hero">
            ...
            <header>
                <div class="sticky-nav fade-in">
                    <div class="container">
                        ...
                        <div class="logo">
                            <a href="#home" title="Logo"><span class="fa fa-ticket logo-icon"></span>
                        ...
                        <nav id="menu">
                            <ul id="menu-nav">
                                <li id="liHomeMobile" runat="server"><a href="#home">Home</a></li>
                                <li id="liAboutUsMobile" runat="server"><a href="#about">About Us</a></li>
                                <li id="liServicesMobile" runat="server"><a href="#services">Services</a></li>
                                <li id="liPortfolioMobile" runat="server"><a href="#work">portfolio</a></li>
                                <li id="liContactMobile" runat="server"><a href="#contact">Contact</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
            ...
            <div class="section" id="about" runat="server" clientidmode="Static">
                <div class="container">
                    <!-- Title Page -->
            ...
            <div runat="server" clientidmode="Static" class="divider-wrapper" id="services">
                <div class="container">
            ...
            <div class="section" id="work" runat="server" clientidmode="Static">
                <div class="container">
                            ...
                            <section id="projects">
                                <ul id="thumbs" style="width:100%;">
                                    ...
                                    <asp:Repeater ID="rptGallery" runat="server">
                                        <ItemTemplate>
                                            <li class="portfolio-item image-wrap col-md-3 design" style="transform:none !important;">
                                                ...
                                                <img style="transform:none !important;float:left;" src="<%#DataAccess.Classes.ClsCommon.TemplateGalleryImagesPath %><%#Eval("Image") %>" alt="<%#Eval("Image") %>" />
                                            </li>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </ul>
            ...
            <div id="mapwrapper" runat="server" clientidmode="Static">
                <div id="googleMap"></div>
            </div>

            <div class="section" id="contact" runat="server" clientidmode="Static" style="padding: 50px 15px">
                <div class="container">
                    <!-- Title Page -->
                                ...
                                <asp:Repeater ID="rptContact" runat="server">
                                    <ItemTemplate>
                                        <ul>
                                            ...
                                            <li style='<%#Eval("City").ToString().Length>0?"display:block;": "display:none;"%>'><i class="fa fa-location-arrow"></i><%#Eval("City") %> <%#Eval("State") %> <%#Eval("PostalCode") %></li>
                                            <%--<li style='<%#Eval("State").ToString().Length>0?"display:block;": "display:none;"%>'><i class="fa fa-home"></i></li>--%>
                                            ...
                                            <li style='<%#Eval("Website").ToString().Length>0?"display:block;": "display:none;"%>'><i class="fa fa-globe"></i><a href="http://<%#Eval("Website") %>"><%#Eval("Website") %></a></li>
                                        </ul>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </div>
                        ...
                        <asp:Repeater ID="rptSocialLink" runat="server">
                            <ItemTemplate>
                                <div id="footer-social" class="col-sm-6 col-md-6" style="text-align: left;">
                                    <nav id="social">
                                        <ul>
                                            <li style='<%#Eval("TwitterLink").ToString().Length>0?"": "display:none;"%>'>
                                                <div class="flip">
                                                    <div class="card">
                                            ...
                                            <li style='<%#Eval("PinInterestLink").ToString().Length>0?"": "display:none;"%>'>
                                                <div class="flip">
                                                    <div class="card">
                                            ...
                                            <li style='<%#Eval("FaceBookLink").ToString().Length>0?"": "display:none;"%>'>
                                                <div class="flip">
                                                    <div class="card">
                                            ...
                                            <li style='<%#Eval("GoogleLink").ToString().Length>0?"": "display:none;"%>'>
                                                <div class="flip">
                                                    <div class="card">
                                            ...
                                            <li style='<%#Eval("TumblerLink").ToString().Length>0?"": "display:none;"%>'>
                                                <div class="flip">
                                                    <div class="card">

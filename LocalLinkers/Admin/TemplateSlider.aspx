<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="TemplateSlider.aspx.cs" Inherits="LocalLinkers.Admin.TemplateSlider" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        function EditTemplateSlider(btn) {
            ...
            $('#<%=target.ClientID%>').attr('src', "/Admin/TemplateSliderImages/" + image);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- END PAGE BAR -->
    <!-- BEGIN PAGE TITLE-->
    <h3 class="page-title">Home Slider
    ...
    <div class="row TemplateSliderPanel" id="TemplateSliderForm" runat="server">
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-red sbold uppercase">Add Home Slider</span>
                    </div>
                    <div class="actions">
                    ...
                    <div id="form_sample_1" class="form-horizontal">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <asp:TextBox ID="txtTitle" TextMode="MultiLine" runat="server" class="form-control" MaxLength="1000" />
                                </div>
                            </div>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        <asp:Button ID="btnTemplateSlider" OnClick="btnTemplateSlider_Click" OnClientClick="return CheckValidation()" Text="Submit" class="btn green" runat="server" />
    ...
    <div class="row GridTemplateSlider" id="GridTemplateSliderPanel" runat="server">
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">Home Slider</span>
                    </div>
                    <div class="actions">
                        <%--<div class="btn-group btn-group-devided" data-toggle="buttons">
                            <a onclick="ShowTemplates();">
                                ...
                                <asp:Repeater ID="rptTemplate" runat="server">
                                    <ItemTemplate>
                                        <tr role="row" class="filter" id="Row_<%#Eval("Id") %>">
                                            <td><%#Eval("SNO") %> </td>
                                            <td>
                                                <img class="category_img" src="<%#Eval("Image").ToString()!="" && Eval("Image").ToString()!=null?DataAccess.Classes.ClsCommon.TemplateSliderImagesPath + Eval("Image"):"/Admin/Images/no-image-icon.png" %>" alt="<%#Eval("Image") %>" /></td>
                                            <td><%#Eval("TemplateName") %>  </td>
                                            <td><%#Eval("Title") %>  </td>
                                            <td><%#Eval("IsApprovedByAdmin") %>  </td>
                                            <td><a class="toggle" data-id="<%#Eval("Id") %>" data-templateid="<%#Eval("templateid") %>" data-title="<%#Eval("Title") %>" data-image='<%#Eval("Image") %>' data-isapprovedbyadmin="<%#Eval("IsApprovedByAdmin") %>" onclick="EditTemplateSlider(this)">
                                                <label class="btn btn-transparent blue btn-outline btn-circle btn-sm active">
                                                    Edit</label></a>
                                                <a class="toggle delete" data-type="TemplateSlider" data-id="<%#Eval("Id") %>">
                                                    <label class="btn btn-transparent red btn-outline btn-circle btn-sm active">
                                                        Delete</label></a>
                                            </td>
                                        </tr>

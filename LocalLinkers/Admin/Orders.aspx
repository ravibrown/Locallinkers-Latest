            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                ...
                <div class="portlet-body" style="padding-bottom: 50px;">
                    <div class="col-md-12" style="margin-bottom: 20px;">
                        <asp:DropDownList ID="drpPage" runat="server" OnSelectedIndexChanged="drpPage_OnSelectedIndexChanged" AutoPostBack="true" class="form-control" Style="width: 100px; margin-left: 20px; display: initial;">

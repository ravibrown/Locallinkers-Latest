                    ...
                    <div id="form_sample_1" class="form-horizontal">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <asp:TextBox ID="txtAboutUs" TextMode="MultiLine" runat="server" class="form-control" MaxLength="1000" />
                                </div>
                            </div>
                                ...
                                <asp:Repeater ID="rptTemplate" runat="server">
                                    <ItemTemplate>
                                        <tr role="row" class="filter" id="Row_<%#Eval("Id") %>">
                                            ...
                                            <td><a class="toggle" data-id="<%#Eval("Id") %>" data-templateid="<%#Eval("templateid") %>" data-aboutus="<%#Eval("AboutUs") %>" data-image='<%#Eval("Image") %>' data-isapprovedbyadmin="<%#Eval("IsApprovedByAdmin") %>" onclick="EditTemplateAboutUs(this)">

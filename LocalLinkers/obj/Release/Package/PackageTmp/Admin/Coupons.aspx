<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Coupons.aspx.cs" Inherits="LocalLinkers.Admin.Coupons" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function EditCoupon(btn) {
            ...
            var isasperbill = $(btn).attr('data-isasperbill');
            ...
            if (isasperbill == "True") {
                $('#<%=chkIsAsPerBill.ClientID%>').prop("checked", true);
                $('#<%=chkIsAsPerBill.ClientID%>').parent().addClass('checked');
            }
            else {
                $('#<%=chkIsAsPerBill.ClientID%>').parent().removeClass('checked');
            }
        ...
        function ResetAll() {
            ...
            $('#<%=chkIsAsPerBill.ClientID%>').prop("checked", false);
                    ...
                    <div id="form_sample_1" class="form-horizontal">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <asp:TextBox ID="txtPayToMerchant" onkeypress="return isNumberKey(event)" runat="server" class="form-control NoCopyPaste shortwidth_80" MaxLength="20" />
                                    <div class="perbill">
                                    <asp:CheckBox ID="chkIsAsPerBill"  Text="" runat="server" />
                                    As per bill
                                        </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <asp:CheckBox ID="chkCoupon" CssClass="couponCheck" Text="" runat="server" />
                                </div>
                            </div>
                        </div>

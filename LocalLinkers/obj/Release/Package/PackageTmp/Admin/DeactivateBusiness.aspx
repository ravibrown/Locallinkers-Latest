<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="DeactivateBusiness.aspx.cs" Inherits="LocalLinkers.Admin.DeactivateBusiness" EnableEventValidation="false" %>
...
<%--            if (Website == "") {
        ...
        function ActivateBusiness(btn) {
            var id = $(btn).attr('data-id');
            CenterLoaderShow();
            $.ajax({
                url: '/Admin/DeactivateBusiness.aspx/ActivateBusiness',
                type: "POST",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: '{ "Id":"' + parseInt(id) + '"}',
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 100%">
        ...
        <small>Deactivate Business Listing</small>
        </h3>
...
<%--                                                <a class="toggle delete" data-type="Business" data-id="<%#Eval("Id") %>">
                                                ...
                                                <a class="toggle" data-type="Business" onclick="ActivateBusiness(this);" data-id="<%#Eval("Id") %>">
                                                    <label class="btn btn-transparent red btn-outline btn-circle btn-sm active">
                                                        Activate</label></a>
                                            </td>
                                        </tr>

...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <header id="mobile-header" class="hidden-desktop clearfix">
                <div id="nav">
                    <ul class="clearfix">
                        <li><a class="scroll-link" href="#header" data-soffset="0">Home</a></li>
                        ...
                        <li><a class="scroll-link" href="#news" data-soffset="0">portfolio</a></li>
            ...
            <div class="header-fixed-nav hidden-phone hidden-tablet">
                <div class="nav">
                    <asp:Repeater ID="rptTemplate" runat="server">
                        <ItemTemplate>
                            <a href="#">
                                <img src="<%#DataAccess.Classes.ClsCommon.TemplateImagesPath %><%#Eval("IconImage") %>" alt="<%#Eval("IconImage") %>" class="logoimgtemp">
                            </a>
                            <h1><%#Eval("Title") %></h1>
                        </ItemTemplate>
                    </asp:Repeater>
                    <ul>
                        <li><a id="header-linker" class="scroll-link active" href="#header" data-soffset="0">home</a></li>
                        <li><a id="about-linker" class="scroll-link" href="#about" data-soffset="0">about</a></li>
                        <!--<li><a id="portfolio-linker" class="scroll-link" href="#portfolio" data-soffset="0">portfolio</a></li>-->
                        <li><a id="services-linker" class="scroll-link" href="#services" data-soffset="0">services</a></li>
                        <li><a id="news-linker" class="scroll-link" href="#news" data-soffset="0">portfolio</a></li>
                        <li><a id="contact-linker" class="scroll-link" href="#contact" data-soffset="0">contact</a></li>
                    </ul>
                </div>
                <div class="nav2">
                    <asp:Repeater ID="rptSocialLink" runat="server">
                        <ItemTemplate>
                            <div style='<%#Eval("FaceBookLink").ToString().Length>0?"display:block;": "display:none;"%>'><a href="http://<%#Eval("FaceBookLink") %>" class="facebook-icon"></a></div>
                            <div style='<%#Eval("GoogleLink").ToString().Length>0?"display:block;": "display:none;"%>'><a href="http://<%#Eval("GoogleLink") %>" class="google-plus-icon"></a></div>
                            <div style='<%#Eval("TwitterLink").ToString().Length>0?"display:block;": "display:none;"%>'><a href="http://<%#Eval("TwitterLink") %>" class="twitter-icon"></a></div>
                            <div style='<%#Eval("PinInterestLink").ToString().Length>0?"display:block;": "display:none;"%>'><a href="http://<%#Eval("PinInterestLink") %>" class="icon-pinterest" style="float: left; width: 100%;"></a></div>
                            <div style='<%#Eval("TumblerLink").ToString().Length>0?"display:block;": "display:none;"%>'><a href="http://<%#Eval("TumblerLink") %>" class="def"></a><i class="fa fa-tumblr"></i></div>
                        </ItemTemplate>
                    </asp:Repeater>
	...
	================================================== -->
            ...
            <div id="services" class="page bg-white" style="padding: 15px 0 0 0">
            ...
            <div id="contact" class="page bg-white">
                <section class="container-fluid  page-bg-img">
                    <div class="row-fluid">
                        <section class="container">
                            <div class="row">
                                        ...
                                        <article class="span12">
                                            <div class="contact-address iconaddress">
                                                <asp:Repeater ID="rptContact" runat="server">
                                                    <ItemTemplate>
                                                        <p style='<%#Eval("Website").ToString().Length>0?"display:block;": "display:none;"%>'><i class="fa fa-briefcase"></i><a href="http://<%#Eval("Website") %>"><%#Eval("Website") %></a></p>
                                                        ...
                                                        <p style='<%#Eval("Website").ToString().Length>0?"display:block;": "display:none;"%>'><i class="fa fa-tablet"></i><a href="http://<%#Eval("Website") %>"><%#Eval("Website") %></a></p>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                            </div>
                                        </article>

...
<body>
    ...
    <form id="form1" runat="server">
		...
		<![endif]-->
            ...
            <section class="features-list" id="features" style="padding: 60px 0px 90px;">
                <div class="container">
            ...
            <section class="download downloadmapaddress" id="download">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <asp:Repeater ID="rptSocialLink" runat="server">
                            <ItemTemplate>
                                <ul class="socialmedialink">
                                    <li class="twitter" style='background-color: #f0f0f0; <%#Eval("TwitterLink").ToString().Length>0?"display:block;": "display:none !important;"%>'><a target="_blank" href="http://<%#Eval("TwitterLink") %>">Twitter </a></li>
                                    <li class="facebook" style='background-color: #f0f0f0; <%#Eval("FaceBookLink").ToString().Length>0?"display:block;": "display:none !important;"%>'><a target="_blank" href="http://<%#Eval("FaceBookLink") %>">Facebook</a> </li>
                                    <li class="googleplus" style='background-color: #f0f0f0; <%#Eval("GoogleLink").ToString().Length>0?"display:block;": "display:none !important;"%>'><a target="_blank" href="http://<%#Eval("GoogleLink") %>">Google +r</a> </li>
                                    <li class="pinterest" style='background-color: #f0f0f0; <%#Eval("PinInterestLink").ToString().Length>0?"display:block;": "display:none !important;"%>'><a target="_blank" href="http://<%#Eval("PinInterestLink") %>">Pinterest</a> </li>
                                    <li class="tumblr" style='background-color: #f0f0f0; <%#Eval("TumblerLink").ToString().Length>0?"display:block;": "display:none !important;"%>'><a target="_blank" href="http://<%#Eval("TumblerLink") %>">Tumblr</a> </li>
                                </ul>
                            </ItemTemplate>
                        </asp:Repeater>
                    </div>
        ...
        <div class="overlay overlay-boxify">
            <nav>
                <ul>
                    ...
                    <li><a href="#features"><i class="fa fa-flash"></i>Services</a></li>
                </ul>
                <ul>
